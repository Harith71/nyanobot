...
module.exports = {
    name: 'attr',
    description: 'Retrieve attr of the cat',
    setClient,
                ...
                if (fileNumber in fileData && fileNumber in imageData) {
                    try {
                        ...
                        const Embed = new EmbedBuilder()
                            ...
                            .addFields(fields)
                            .setURL(assetURL)
                            .setFooter({ text: 'Nyano Cats Bot', iconURL: config.embedFooterImage })
                            .setTimestamp();

                        // Send a message with the Embed and attached image
                        message.reply({
                            content: `${message.author} has requested attribute information on ${imageData[fileNumber].name}.`,
                            embeds: [Embed],
